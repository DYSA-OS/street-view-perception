...
def training(class_name, result_dir):
    df_train = pd.read_csv(f'./data/hrnet_train_{class_name}.csv')
    df_val = pd.read_csv(f'./data/hrnet_val_{class_name}.csv')
    df_test = pd.read_csv(f'./data/hrnet_test_{class_name}.csv')
...
def main():
    ...
    segment_dir = './balanced_results/segment'
