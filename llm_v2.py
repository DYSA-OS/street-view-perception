...
def training(class_name, result_dir):
    ...
    df_train = pd.read_csv(f'./data/prompt_train_{class_name}.csv')
    df_val = pd.read_csv(f'./data/prompt_val_{class_name}.csv')
    df_test = pd.read_csv(f'./data/prompt_test_{class_name}.csv')
